  ...
  return (
    <section className="relative w-full min-h-screen bg-background flex flex-col justify-center py-8 md:py-12 lg:py-16 overflow-hidden">
      ...
      <div className="w-full max-w-[1400px] mx-auto relative z-30 flex flex-col items-center px-4 md:px-6">
        ...
        {/* FIXES: 
            - Added 'md:overflow-visible' so underlines don't clip on desktop
            - Adjusted 'w-[calc(100%+32px)]' and '-mx-4' to ensure full-width scroll on mobile
            - Added explicit 'pl-4 pr-4' so content start/end aligns correctly
        */}
        <div
        ...
        {/* FIXES: 
            - Desktop: Added 'md:overflow-visible' to stop clipping the scale-105 border
            - Mobile: 'pl-4' ensures the first logo starts EXACTLY at the viewer's edge
            - Layout: 'justify-between' on desktop keeps them pinned to edges
        */}
        <div
