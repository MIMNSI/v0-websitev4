          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="prose prose-invert max-w-none">
              <p className="text-gray-300 mb-6 leading-relaxed">
                This Privacy Policy, describes how MetaShop Private Limited, (hereinafter referred to as "Company, Us,
                We, Our") collects, uses, shares, protects and processes you personal information obtained from our
                website MetaShop AI &lt;
                ...
                Use (hereinafter referred to as "Terms") and agree to be governed by all the laws of India, including
                but not limited to the applicable laws on data protection and privacy. Capitalise terms which are not
              ...
              <ol className="space-y-8 text-gray-300">
                <li className="space-y-4">
                  ...
                  <ol className="list-decimal list-inside space-y-2 ml-4">
                    ...
                    <li>
                      All other data not explicitly enumerated herein shall be utilised in accordance with the
                      provisions set forth in this Privacy Policy or as otherwise revealed during the data collection
                      process.
                    </li>
                  </ol>
                  ...
                  <ol className="list-decimal list-inside space-y-2 ml-4">
                    <li>
                      We may collect your information from your interaction with Our social media pages including but
                      not limited to Instagram, Facebook, Linkedin, Twitter, Pinterest and Youtube.
                    </li>
                    <li>
                  ...
                  <ol className="list-decimal list-inside space-y-2 ml-4">
                    ...
                    <li>
                      Camera, and video – this information is collected because many services on Our Website require us
                      to collect videos from your device's camera and photo gallery.
                    </li>
                  </ol>
                </li>
                ...
                <li className="space-y-4">
                  ...
                  <p className="leading-relaxed">
                    The Website uses data collection devices such as "cookies" on certain pages of the Website to
                    analyse Our web page flow, measure promotional effectiveness and promote trust and safety. Cookies
                    are small files placed on your hard drive that assist Us in providing the best of Our services to
                    you. These cookies do not contain any personal information of the user. Cookies help Us to provide
                    information to you that is targeted to your interests. There are certain session Cookies which are
                    deleted from your hard drive automatically at the end of your session on the Website. You are always
                    free to decline/delete Our Cookies if your browser permits, although in that case We may not be able
                ...
                <li className="space-y-4">
                  ...
                  <p className="leading-relaxed">
                    We put the data we acquire from Our Website to several different types of business purposes
                    mentioned below. These uses of your personal information are based on Our legitimate business
                    interests, your permission, Our contractual responsibilities, and/or Our legal requirements. We use
                    personal information obtained through the utilisation of Our Website for an array of business
                    objectives as delineated hereunder:
                  </p>
                  <ol className="list-decimal list-inside space-y-2 ml-4">
                    <li>
                      provide, develop, operate, improve, deliver, maintain the Service as offered by the Website;
                    </li>
                    ...
                    <li>
                      We may process your data if you have granted us explicit permission to use your personal
                    ...
                    <li>
                      to comply with applicable laws, lawful requests, and legal process, including responding to
                ...
                <li className="space-y-4">
                  ...
                  <p className="leading-relaxed">
                    ...
                    providers, merchants, affiliates, associates, subsidiaries, legally recognized authorities,
                    regulatory bodies, governmental authorities, financial institutions, internal teams, etc. The
                    personal information shall be shared where applicable and, on a need-to-know basis, for the
                    following purposes:
                  </p>
                  <ol className="list-decimal list-inside space-y-2 ml-4">
                    ...
                    <li>
                      communicate with you about the Service, including but not limited to sending announcements,
                      updates, security updates and support and administrative messages;
                    </li>
                    ...
                    <li>
                      for complying with the applicable laws as well as meeting the Know-Your-Customer (KYC)
                      requirements as mandated by the regulatory bodies;
                    </li>
                ...
                <li className="space-y-4">
                  ...
                  <p className="leading-relaxed">
                    ...
                    that the security of data transmission over the Internet cannot be guaranteed in its entirety.
                    Whereas our utmost endeavour is to safeguard your personal information, we are unable to provide a
                    guarantee of the security of said personal information.
                  </p>
                </li>
                ...
                <li className="space-y-4">
                  ...
                  <p className="leading-relaxed">
                    ...
                    (promotional, marketing-related) communications from Us after setting up an account on the Website.
                    If you do not wish to receive the promotional communications from Us, then please unsubscribe by
                ...
                <li className="space-y-4">
                  ...
                  <p className="leading-relaxed">
                    ...
                    parent or guardian. We do not knowingly solicit or collect personal information from minors under
                    the age of 18 years.
                  </p>
                </li>
                ...
                <li className="space-y-4">
                  ...
                  <p className="leading-relaxed">
                    We might retain your information for a period of time as provided by applicable laws. Your data
                    shall be retained by Us if:
                  </p>
                  <ol className="list-decimal list-inside space-y-2 ml-4">
                ...
                <li className="space-y-4">
                  ...
                  <p className="leading-relaxed">
                    ...
                    can contact Our grievance officer at: info@metashopai.com
                  </p>
                </li>
