(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
  ...
  (e) => {
    ...
    var t = e.i(75141),
      r = e.i(15994);
    function s({ className: e, type: s, ...n }) {
  ...
  (e) => {
    "use strict";
    let t = (0, e.i(27460).default)("ChevronDown", [
  ...
  (e) => {
    ...
    var t = e.i(75141),
      ...
      s = e.i(44576),
      n = e.i(59939);
    let i = (0, e.i(27460).default)("Menu", [
              ...
              (0, t.jsxs)("div", {
                ...
                children: [
                  ...
                  (0, t.jsx)("button", {
                    ...
                    onClick: () => o(!e),
                    children: (0, t.jsx)(i, { className: "w-5 h-5" }),
                  }),
                ],
              }),
            ],
  ...
  (e) => {
    ...
    e.s([
      ...
      ({ children: e, className: r }) =>
        (0, t.jsx)("div", {
          className: (0, s.cn)("h-96 w-full [transform-style:preserve-3d]", r),
          children: e,
        }),
      "CardContainer",
      0,
      ({ children: e, className: i, containerClassName: a }) => {
        let o = (0, r.useRef)(null),
          [l, d] = (0, r.useState)(!1);
        return (0, t.jsx)(n.Provider, {
          value: { isMouseEntered: l, setIsMouseEntered: d },
          children: (0, t.jsx)("div", {
            className: (0, s.cn)("flex items-center justify-center", a),
            ...
            children: (0, t.jsx)("div", {
              ...
              onMouseMove: (e) => {
                ...
                let {
                  ...
                  i = (e.clientX - t - s / 2) / 15,
                  a = (e.clientY - r - n / 2) / 15;
                o.current.style.transform = `rotateY(${i}deg) rotateX(${-a}deg)`;
              },
              onMouseLeave: () => {
                o.current &&
                  (d(!1),
      ...
      "CardItem",
      0,
      ({ as: e = "div", children: i, className: a, translateZ: o = 0 }) => {
        let l = (0, r.useRef)(null),
          { isMouseEntered: d } = (0, r.useContext)(n) || {};
        return (
          (0, r.useEffect)(() => {
            l.current &&
              (d
                ? (l.current.style.transform = `translateZ(${o}px)`)
                : (l.current.style.transform = "translateZ(0px)"));
          }, [d, o]),
          (0, t.jsx)(e, {
            ref: l,
            className: (0, s.cn)(
      ...
      return (
        ...
        [
          function (s, n) {
            ...
            i = [...i, n];
            let l = (s) => {
              let { scope: n, children: i, ...l } = s,
                d = n?.[e]?.[o] || a,
                c = t.useMemo(() => l, Object.values(l));
              return (0, r.jsx)(d.Provider, { value: c, children: i });
            };
            return (
  ...
  (e) => {
                ...
                d = (function (e, t) {
                  ...
                  for (let s in t) {
                    ...
                    /^on[A-Z]/.test(s)
                      ...
                      ? (r[s] = { ...n, ...i })
                      : "className" === s &&
                        (r[s] = [n, i].filter(Boolean).join(" "));
                  }
                  return { ...e, ...r };
                })(i, n.props);
              return (
                n.type !== t.Fragment &&
                  (d.ref = r ? (0, s.composeRefs)(r, l) : l),
                t.cloneElement(n, d)
              );
            }
          ...
          if (d) {
            ...
            return (0, n.jsx)(a, {
              ...
              children: t.isValidElement(e)
                ? t.cloneElement(e, void 0, s)
                : null,
            });
          }
          return (0, n.jsx)(a, { ...i, ref: r, children: s });
        });
    ...
    function l(e) {
      let a = e + "CollectionProvider",
        [o, l] = (0, r.createContextScope)(a),
        [d, c] = o(a, { collectionRef: { current: null }, itemMap: new Map() }),
        u = (e) => {
      ...
      let p = e + "CollectionSlot",
        ...
        m = t.default.forwardRef((e, t) => {
          let { scope: r, children: i } = e,
            a = c(p, r),
            o = (0, s.useComposedRefs)(t, a.collectionRef);
          return (0, n.jsx)(f, { ref: o, children: i });
        });
      m.displayName = p;
      let h = e + "CollectionItemSlot",
        ...
        y = t.default.forwardRef((e, r) => {
          let { scope: i, children: a, ...o } = e,
            l = t.default.useRef(null),
            d = (0, s.useComposedRefs)(r, l),
            u = c(h, i);
          return (
            t.default.useEffect(
              () => (
            ...
            (0, n.jsx)(g, { ...{ [x]: "" }, ref: d, children: a })
          );
        });
      return (
        (y.displayName = h),
        [
          { Provider: u, Slot: m, ItemSlot: y },
          function (r) {
            let s = c(e + "CollectionConsumer", r);
            return t.default.useCallback(() => {
              let e = s.collectionRef.current;
              if (!e) return [];
    ...
    (class e extends Map {
      ...
      insert(e, t, r) {
        let s,
          ...
          o = a >= 0 ? a : i + a,
          l = o < 0 || o >= i ? -1 : o;
        if (l === this.size || (n && l === this.size - 1) || -1 === l)
        ...
        for (let e = o; e < d; e++)
          if (o === e) {
            ...
            let r = c[p ? e : e - 1],
              n = s;
            (s = this.get(r)), this.delete(r), this.set(r, n);
          }
        return this;
      }
      with(t, r, s) {
        let n = new e(this);
        return n.insert(t, r, s), n;
      }
      before(e) {
      ...
      setBefore(e, t, r) {
        let s = this.#e.indexOf(e);
        return -1 === s ? this : this.insert(s, t, r);
      }
      after(e) {
      ...
      setAfter(e, t, r) {
        let s = this.#e.indexOf(e);
        return -1 === s ? this : this.insert(s + 1, t, r);
      }
      first() {
      ...
      from(e, t) {
        ...
        let s = r + t;
        return (
          s < 0 && (s = 0), s >= this.size && (s = this.size - 1), this.at(s)
        );
      }
      keyFrom(e, t) {
        let r = this.indexOf(e);
        ...
        let s = r + t;
        return (
          s < 0 && (s = 0), s >= this.size && (s = this.size - 1), this.keyAt(s)
        );
      }
      find(e, t) {
        let r = 0;
        for (let s of this) {
          if (Reflect.apply(e, t, [s, r, this])) return s;
          r++;
        }
      }
      findIndex(e, t) {
        let r = 0;
        for (let s of this) {
          if (Reflect.apply(e, t, [s, r, this])) return r;
          r++;
        }
        return -1;
      }
      filter(t, r) {
        let s = [],
          n = 0;
        for (let e of this) Reflect.apply(t, r, [e, n, this]) && s.push(e), n++;
        return new e(s);
      }
      map(t, r) {
        let s = [],
          n = 0;
        for (let e of this)
          s.push([e[0], Reflect.apply(t, r, [e, n, this])]), n++;
        return new e(s);
      }
      reduce(...e) {
        let [t, r] = e,
        ...
        for (let r of this)
          (n =
            0 === s && 1 === e.length
              ? r
              : Reflect.apply(t, this, [n, r, s, this])),
            s++;
        return n;
      }
      reduceRight(...e) {
        ...
        for (let r = this.size - 1; r >= 0; r--) {
          ...
          s =
            r === this.size - 1 && 1 === e.length
              ? n
              : Reflect.apply(t, this, [s, n, r, this]);
        }
        return s;
      }
      toSorted(t) {
      ...
      every(e, t) {
        let r = 0;
        for (let s of this) {
          if (!Reflect.apply(e, t, [s, r, this])) return !1;
          r++;
        }
        return !0;
      }
      some(e, t) {
        let r = 0;
        for (let s of this) {
          if (Reflect.apply(e, t, [s, r, this])) return !0;
          r++;
        }
        return !1;
      }
    }),
      e.s(["createCollection", () => l], 42394);
  },
  4704,
  31469,
  (e) => {
    "use strict";
    function t(e, r, { checkForDefaultPrevented: s = !0 } = {}) {
      return function (t) {
        if ((e?.(t), !1 === s || !t.defaultPrevented)) return r?.(t);
      };
    }
    ...
    var r = e.i(96592),
      s = globalThis?.document ? r.useLayoutEffect : () => {};
    globalThis?.document && r.useLayoutEffect,
      r[" useEffectEvent ".trim().toString()],
      r[" useInsertionEffect ".trim().toString()];
    var n = r[" useInsertionEffect ".trim().toString()] || s;
    function i({ prop: e, defaultProp: t, onChange: s = () => {}, caller: i }) {
      let [a, o, l] = (function ({ defaultProp: e, onChange: t }) {
          ...
          return (
            ...
            r.useEffect(() => {
              a.current !== s && (o.current?.(s), (a.current = s));
            }, [s, a]),
            [s, i, o]
          );
        })({ defaultProp: t, onChange: s }),
        d = void 0 !== e,
        c = d ? e : a;
      {
    ...
    Symbol("RADIX:SYNC_STATE"), e.s(["useControllableState", () => i], 31469);
  },
  84753,
  (e) => {
    "use strict";
      ...
      let l,
        ...
        u =
          ...
          ((c = t.forwardRef((e, r) => {
            ...
            return (0, s.jsx)(d, { ...a, ref: r, children: n });
          })).displayName = `${a}.Slot`),
          c),
        p = t.forwardRef((e, t) => {
          let { asChild: r, ...i } = e;
          return (
            ...
            (0, s.jsx)(r ? u : n, { ...i, ref: t })
          );
        });
      return (p.displayName = `Primitive.${n}`), { ...e, [n]: p };
    }, {});
    e.s(["Primitive", () => a], 84753);
  },
  43514,
  (e) => {
    "use strict";
    var t = e.i(96592),
      r = e.i(70946),
      s = globalThis?.document ? t.useLayoutEffect : () => {},
      n = (e) => {
        var n;
        let a,
          o,
          ...
          p = (0, r.useComposedRefs)(
            ...
            ((n = u),
            (o =
              (a = Object.getOwnPropertyDescriptor(n.props, "ref")?.get) &&
              "isReactWarning" in a &&
              a.isReactWarning)
              ? n.ref
              : (o =
    ...
    (n.displayName = "Presence"), e.s(["Presence", () => n], 43514);
  },
  42193,
  32659,
  (e) => {
    ...
    var t = e.i(96592),
      ...
      s = t[" useId ".trim().toString()] || (() => void 0),
      n = 0;
    function i(e) {
      let [i, a] = t.useState(s());
      return (
        r(() => {
          e || a((e) => e ?? String(n++));
        }, [e]),
  ...
  (e) => {
    ...
    var t = e.i(75141),
      r = e.i(96592);
    let s = (0, e.i(27460).default)("Search", [
    ...
    b.displayName = x;
    var N = "CollapsibleTrigger",
      j = r.forwardRef((e, r) => {
        let { __scopeCollapsible: s, ...n } = e,
          i = w(N, s);
        return (0, t.jsx)(p.Primitive.button, {
          ...
          ...n,
          ref: r,
          onClick: (0, c.composeEventHandlers)(e.onClick, i.onOpenToggle),
        });
      });
    j.displayName = N;
    var k = "CollapsibleContent",
      C = r.forwardRef((e, r) => {
        let { forceMount: s, ...n } = e,
          i = w(k, e.__scopeCollapsible);
        return (0, t.jsx)(m.Presence, {
          present: s || i.open,
          children: ({ present: e }) =>
            (0, t.jsx)(A, { ...n, ref: r, present: e }),
        });
      });
    C.displayName = k;
    var A = r.forwardRef((e, s) => {
      let { __scopeCollapsible: n, present: i, children: a, ...o } = e,
        l = w(k, n),
        [c, u] = r.useState(i),
        m = r.useRef(null),
        h = (0, d.useComposedRefs)(s, m),
        x = r.useRef(0),
        g = x.current,
        y = r.useRef(0),
        v = y.current,
    ...
    var S = e.i(32659),
      I = "Accordion",
      q = ["Home", "End", "ArrowDown", "ArrowUp", "ArrowLeft", "ArrowRight"],
      [D, O, E] = (0, l.createCollection)(I),
      [M, P] = (0, o.createContextScope)(I, [E, y]),
      _ = y(),
    ...
    z.displayName = I;
    var [T, W] = M(I),
      [F, L] = M(I, { collapsible: !1 }),
      $ = r.default.forwardRef((e, s) => {
        let {
            value: n,
            defaultValue: i,
            onValueChange: a = () => {},
        ...
        return (0, t.jsx)(T, {
          ...
          onItemOpen: c,
          onItemClose: r.default.useCallback(() => o && c(""), [o, c]),
          children: (0, t.jsx)(F, {
            scope: e.__scopeAccordion,
            collapsible: o,
            children: (0, t.jsx)(V, { ...l, ref: s }),
          }),
        });
      }),
      U = r.default.forwardRef((e, s) => {
        let {
            value: n,
            defaultValue: i,
            onValueChange: a = () => {},
        ...
        return (0, t.jsx)(T, {
          ...
          children: (0, t.jsx)(F, {
            scope: e.__scopeAccordion,
            collapsible: !0,
            children: (0, t.jsx)(V, { ...o, ref: s }),
          }),
        });
      }),
      [H, B] = M(I),
      V = r.default.forwardRef((e, s) => {
        let {
            __scopeAccordion: n,
            disabled: i,
            dir: a,
          ...
          f = (0, d.useComposedRefs)(u, s),
          m = O(n),
          h = "ltr" === (0, S.useDirection)(a),
          x = (0, c.composeEventHandlers)(e.onKeyDown, (e) => {
            if (!q.includes(e.key)) return;
            let t = e.target,
              r = m().filter((e) => !e.ref.current?.disabled),
              s = r.findIndex((e) => e.ref.current === t),
              n = r.length;
            if (-1 === s) return;
            e.preventDefault();
            let i = s,
      ...
      Q = r.default.forwardRef((e, r) => {
        let { __scopeAccordion: s, value: n, ...i } = e,
          a = B(Y, s),
          o = W(Y, s),
          l = _(s),
          d = (0, h.useId)(),
    ...
    var K = "AccordionHeader",
      X = r.default.forwardRef((e, r) => {
        let { __scopeAccordion: s, ...n } = e,
          i = B(I, s),
          a = G(K, s);
        return (0, t.jsx)(p.Primitive.h3, {
    ...
    var J = "AccordionTrigger",
      ee = r.default.forwardRef((e, r) => {
        let { __scopeAccordion: s, ...n } = e,
          i = B(I, s),
          a = G(J, s),
          o = L(J, s),
          l = _(s);
        return (0, t.jsx)(D.ItemSlot, {
          scope: s,
          children: (0, t.jsx)(j, {
    ...
    ee.displayName = J;
    var et = "AccordionContent",
      er = r.default.forwardRef((e, r) => {
        let { __scopeAccordion: s, ...n } = e,
          i = B(I, s),
          a = G(et, s),
          o = _(s);
    ...
    var en = e.i(41331),
      ...
      ei = e.i(15994);
    function ea({ ...e }) {
      return (0, t.jsx)(z, { "data-slot": "accordion", ...e });
    }
    function eo({ className: e, ...r }) {
      return (0, t.jsx)(Q, {
        "data-slot": "accordion-item",
        className: (0, ei.cn)("border-b last:border-b-0", e),
        ...r,
      });
    }
    function el({ className: e, children: r, ...s }) {
      return (0, t.jsx)(X, {
        className: "flex",
    ...
    function ed({ className: e, children: r, ...s }) {
      return (0, t.jsx)(er, {
        ...
        faqs: [
          {
            ...
            answer:
              "Our interactive 3D viewer is fully customizable: Add your logo and brand colors, Include custom audio narration, Insert call-to-action buttons, Create labeled hotspots for key features, Add interactive forms and redirects, Tailor interactions for your specific use case",
          },
          {
            question: "What kind of interactive features can I add?",
            answer:
              "MetaShop AI supports extensive interactivity: Clickable hotspots with information pop-ups, Voice notes and audio guides, Embedded forms for lead capture, Direct links to product pages or booking systems, Custom animations and transitions, Multi-language support",
          },
          {
            question: "Do you provide analytics on viewer engagement?",
            answer:
              "Yes! Built-in viewer analytics track: Total visits and unique viewers, Interaction rates with hotspots, Time spent exploring the model, Device and location data. All insights your marketing team needs to optimize performance.",
          },
        ],
      },
      {
        ...
        faqs: [
          ...
          },
          {
            ...
            answer:
              "One link does it all! The same link works for: Website embedding, Social media sharing, Direct email links, QR codes for physical marketing, Integration into presentations",
          },
          {
            question: "What about mobile compatibility?",
            answer:
              "MetaShop AI works flawlessly across ALL devices: Mobile phones (iOS/Android), Desktop computers, Laptops and tablets, VR headsets, All web browsers. Same performance, zero compromise.",
          },
          {
        ...
        faqs: [
          {
            ...
            answer:
              "MetaShop AI works on all modern web browsers: Chrome, Firefox, Safari, Edge, Mobile browsers (iOS Safari, Android Chrome). No downloads or plugins required. Consistent performance across all platforms.",
          },
          {
            question: "How do you ensure fast loading times?",
            answer:
              "Edge-native rendering technology loads 3D directly on the user's device - no streaming needed. This means: Zero latency loading, No bandwidth limitations, Consistent performance regardless of internet speed, No server dependency during viewing",
          },
          {
...
• No server dependency during viewing`,
          },
          {
            ...
            answer:
              "We offer comprehensive support including: Technical assistance during setup, Hands-on guidance throughout the process, Responsive customer service team, Constant feedback loops for quality assurance, Direct communication at info@metashopai.com",
          },
        ],
      },
      {
...
Studies show 3D reduces returns by up to 40%.`,
          },
          {
            ...
            answer:
              "Immersive 3D experiences help travelers: Explore hotels, restaurants, and venues virtually, Build confidence in their booking choice, Experience the atmosphere before arrival, Share exciting previews with travel companions, Make faster booking decisions",
          },
          {
            ...
            .map((e) => ({
              ...
              faqs: e.faqs.filter(
                (r) =>
                  ...
                  r.answer.toLowerCase().includes(t) ||
                  e.category.toLowerCase().includes(t)
              ),
            }))
            .filter((e) => e.faqs.length > 0);
        }, [e]);
            ...
            children: [
              (0, t.jsxs)("div", {
                ...
                children: [
                  (0, t.jsx)("div", {
                    className:
                      "absolute inset-0 bg-gradient-to-br from-primary/5 via-background to-background",
                  }),
                  (0, t.jsx)("div", {
                    className:
                      "absolute inset-0 bg-[radial-gradient(circle_at_center,_rgba(45,255,167,0.03)_0%,_transparent_50%)]",
                  }),
                ],
              }),
              (0, t.jsx)("div", {
                className:
                  "absolute top-0 left-0 right-0 h-1/3 bg-gradient-to-b from-background to-transparent z-0",
              }),
              (0, t.jsxs)("div", {
                className:
                  "relative z-10 container mx-auto px-4 py-24 md:py-32 max-w-5xl",
                children: [
                  (0, t.jsxs)("div", {
                    className: "text-center mb-12 md:mb-16",
                    children: [
                      (0, t.jsx)("h1", {
                        className: "font-sans ts-h2 md:ts-h1 mb-4 text-white",
                        children: "Frequently Asked Questions",
                      }),
                      (0, t.jsx)("p", {
                        className:
                          "font-sans ts-body1 text-muted max-w-2xl mx-auto mb-8",
                        children:
                      ...
                      (0, t.jsxs)("div", {
                        ...
                        children: [
                          (0, t.jsx)(a.Input, {
                            type: "text",
                            placeholder:
                              "Search FAQs by keywords or categories...",
                            value: e,
                            onChange: (e) => o(e.target.value),
                            className:
                              "font-sans pl-12 pr-4 py-6 text-base bg-dark/50 border-medium/50 focus:border-primary/50 focus:ring-primary/20 backdrop-blur-sm",
                          }),
                          (0, t.jsx)(s, {
                            className:
                              "absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 text-muted pointer-events-none",
                          }),
                        ],
                      }),
                    ],
                      ...
                      l.length > 0
                        ? l.map((e, r) =>
                            (0, t.jsxs)(
                              ...
                              {
                                className:
                                  "bg-dark/30 backdrop-blur-sm rounded-xl border border-medium/30 p-6",
                                children: [
                                  (0, t.jsx)("h2", {
                                    className:
                                      "font-sans font-medium text-[20px] md:text-[24px] lg:text-[28px] text-primary mb-6",
                                    children: e.category,
                                  }),
                                  (0, t.jsx)(ea, {
                                    type: "multiple",
                                    className: "space-y-4",
                                    children: e.faqs.map((e, s) =>
                                      (0, t.jsxs)(
                                        eo,
                                        {
                                          value: `${r}-${s}`,
                                          className:
                                            "border-medium/30 rounded-lg bg-dark/50 px-6",
                                          children: [
                                            (0, t.jsx)(el, {
                                              className:
                                                "font-sans font-medium text-[18px] md:text-[20px] text-white hover:text-primary hover:no-underline text-left",
                                              children: e.question,
                                            }),
                                            (0, t.jsx)(ed, {
                                              className:
                                                "font-sans ts-body2 text-light space-y-4",
                                              children: (0, t.jsx)("div", {
                                                className:
                        ...
                        : (0, t.jsxs)("div", {
                            ...
                            children: [
                              (0, t.jsx)("p", {
                                className: "font-sans ts-body1 text-muted",
                                children:
                              ...
                              (0, t.jsx)("button", {
                                onClick: () => o(""),
                                className:
                                  "font-sans mt-4 ts-body2 text-primary hover:underline",
                  ...
                  (0, t.jsxs)("div", {
                    ...
                    children: [
                      (0, t.jsxs)("div", {
                        ...
                        children: [
                          (0, t.jsx)("h3", {
                            className: "font-sans ts-h4 mb-4 text-white",
                            children: "Still have questions?",
                          }),
                          (0, t.jsx)("p", {
                            className: "font-sans ts-body1 text-light",
                            children:
                      ...
                      (0, t.jsxs)("div", {
                        ...
                        children: [
                          (0, t.jsx)(ec.CardContainer, {
                            className: "w-full",
                            children: (0, t.jsx)(ec.CardBody, {
                              className:
                                "relative group/card bg-[#1A1A1A] rounded-2xl p-6 border border-border/50 hover:shadow-2xl hover:shadow-emerald-500/[0.1] transition-shadow duration-300 h-auto",
                              children: (0, t.jsx)(ec.CardItem, {
                                translateZ: "50",
                                className: "w-full",
                                    ...
                                    (0, t.jsxs)("div", {
                                      ...
                                      children: [
                                        ...
                                        (0, t.jsx)("a", {
                                          ...
                                          className:
                                            "text-white/60 hover:text-primary transition-colors break-all",
                                          children: "info@metashopai.com",
                                        }),
                                      ],
                                    }),
                                  ],
